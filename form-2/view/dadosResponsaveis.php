...
<style>
    ...
    <section class="dados" style="margin-top: 20px;">
        <div class="container">
            ...
            <h4 class="display-6 my-icon"><i class='bx bxs-user-detail' style="margin-right: 20px; font-size: 30x;"></i>Sobre seu resposável</h4>
        </div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h6>Dados do Responsável pelo aluno</h6>
                        </div>
...
<script src="../assents/js/estados.js">
